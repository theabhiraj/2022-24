...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    include '../__connect/connect.php';
    $username = $_POST["username"];
    $password = $_POST["password"];
    //    $monumber = $_POST["monumber"];
    $exists = false;

    $sql = "Select * from shopMan.users where username='$username' AND password='$password'";  //AND monumber='$monumber' 
...
<body>
    <?php require '../__connect/connect.php' ?>
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                ?>
                <div class="card">
                    <div class="card-header text-center">Login shopMan</div>
